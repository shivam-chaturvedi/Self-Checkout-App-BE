    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> 
                auth.requestMatchers("/signup", "/login", "/verify-token","/product/qr/**","/store-cart/qr/**","/store-cart/get-attached-user/**","/cart","/reports/**","/notify-threat","/user-cart/add-item-by-rfid-tag/**").permitAll() // Allow signup/login without authentication
